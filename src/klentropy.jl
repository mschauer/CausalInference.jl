...
"""
    kl_entropy(data::Array{Float64, 2}; k=5)::Float64
...
"""
function kl_entropy(data::Array{Float64, 2}; k=5)::Float64
...
"""
    kl_mutual_information(x::Array{Float64,2}, y::Array{Float64,2}; k=5, bias_correction=true)::Float64
...
"""
function kl_mutual_information(x::Array{Float64,2}, y::Array{Float64,2}; k=5, bias_correction=true)::Float64
...
"""
    kl_renyi(data::Array{Float64, 2}; k=5)::Float64
...
k=5: number of nearest neighbors
"""
function kl_renyi(data::Array{Float64,2}, q, k=5)::Float64
...
"""
    kl_cond_mi(x::Array{Float64,2}, y::Array{Float64,2}, z::Array{Float64,2}; k=5, bias_correction=true)::Float64
...
bias_correction=true: flag to apply Gao's bias correction
"""
function kl_cond_mi(x::Array{Float64,2}, y::Array{Float64,2}, z::Array{Float64,2}; k=5, bias_correction=true)::Float64
...
"""
    kl_perm_mi_test(x::Array{Float64,2}, y::Array{Float64,2}; k=5, B=100, bias_correction=true)::Float64
...
bias_correction=true: flag to apply Gao's bias correction
"""
function kl_perm_mi_test(x::Array{Float64,2}, y::Array{Float64,2}; k=5, B=100, bias_correction=true)::Float64
...
"""
function kl_perm_cond_mi_test(x::Array{Float64,2}, y::Array{Float64,2}, z::Array{Float64,2}; k=5, B=100, kp=5, bias_correction=true)::Float64
